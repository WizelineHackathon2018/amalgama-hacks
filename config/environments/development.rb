Rails.application.configure do
	...
	# config.firebase_logger = Logger.new "#{Rails.root}/log/firebase_activity_dev.log"
	...
	config.action_mailer.default_options = {from: 'no-reply@template.com'}
	config.action_mailer.default :charset => "utf-8"
	ActionMailer::Base.default :from => 'no-reply@template.com'
